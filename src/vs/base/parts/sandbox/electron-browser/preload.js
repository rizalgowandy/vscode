...
(function () {
	...
	/** @type {import('../common/sandboxTypes').ISandboxConfiguration | undefined} */
	...
	const globals = {
		...
		context: {
			 ...
			 * has finished.
			 *
			 * @returns {import('../common/sandboxTypes').ISandboxConfiguration | undefined}
			 */
			configuration() {
				return configuration;
			},
			 ...
			 *
			 * @returns {Promise<import('../common/sandboxTypes').ISandboxConfiguration>}
			 */
